...
const FRENCH_WORDS: FrenchWord[] = [
    ...
    { english: "How do you say '~' in French?", french: "Comment dit-on '~' en français?" },
    { english: "Please repeat", french: "Répétez, s'il vous plaît?" },
    { english: "Please speak more slowly", french: "Parlez plus lentement, s'il vous plaît" },
    ...
    // Self Introduction
    { english: "Hello", french: "Bonjour professeur" },
    ...
    { english: "I've been learning French for 1 month", french: "J'étudie le français depuis un mois" },
...
const FrenchVocabQuiz: React.FC = () => {
    const [remainingWords, setRemainingWords] = useState<FrenchWord[]>(FRENCH_WORDS);
    ...
    const WORD_CSS_TRANSITION_DURATION = 300;
    ...
    const checkAnswer = (e: React.FormEvent) => {
        ...
        if (isCorrect) {
            ...
            const newRemainingWords = remainingWords.filter(word => word.english !== currentWord.english);
    ...
    const getInputColor = (): string => {
        ...
        return userInput.toLowerCase().trim() === currentWord.french.toLowerCase().trim()
            ? "bg-green-100"
            : "bg-red-100";
    };
