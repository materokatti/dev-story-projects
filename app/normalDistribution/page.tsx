        ...
        <div className='relative w-screen h-screen bg-black'>
            ...
            <div className="absolute w-full max-w-md space-y-2 bottom-10 left-1/2 -translate-x-1/2">
                <input
                    ...
                    className="w-full appearance-none bg-transparent [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:bg-gray-700 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white focus:outline-none"
                    style={{
